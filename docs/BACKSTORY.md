...
What follows here are the prompts I employed to help me code generate some pieces of this application.
...
I edited [openapi/kahoot-openapiv3-spec.yml](../src/main/resources/openapi/kahoot-openapiv3-spec.yml) as suggested by adding `scopes: {}`.
...
> I also added a copy of the template to the prompt above. As well, I added a copy of the Reporting API spec. The latter wasn't necessary in hindsight.
